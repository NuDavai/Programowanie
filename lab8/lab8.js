...
/// Zad 1
///
const checkboxField = document.getElementById("tak")
...
let provinceField = document.querySelector("[name='voivodeship']");
const province = document.querySelector('.voivodeship');
const provinceSelect = document.querySelector('.voivodeship.select');
countyField.addEventListener('change', () => {
    ...
    if (countyField.value === "Polska") {
        ...
        provinceField = document.querySelector(".voivodeship.select [name='voivodeship']");
        ...
        provinceField = document.querySelector("[name='voivodeship']");
